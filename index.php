		...
		<div class='row'>
			...
			<div class='col-md-6' >
				...
				<form method='post' action=''>
					...
					<button type="submit" name="btnsignup" style="background-color:orange;color:white;width:150px;
height:40px;" >SUBMIT DATA</button>

					<button style="background-color:green;color:white;width:150px;
height:40px;" onclick="window.location.href='display.php'">SHOW DATA</button>
				</form>
			</div>
